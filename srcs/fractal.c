 ...
 * - Colore: Il numero di iterazioni prima della fuga determina il colore del pixel
...
* - ci: Parte immaginaria della costante c (posizione y del pixel nel piano complesso)
* - tmp_zr: Variabile temporanea per salvare zr durante l'iterazione
* 
* LOGICA DELLA FUNZIONE:
* 1. Inizializza il contatore di profondità a 0
...
* - Mandelbrot: z inizia da 0, c è la posizione del pixel
...
* - ci: Parte immaginaria della costante c (posizione y del pixel, sempre positiva)
* - tmp_zr: Variabile temporanea per salvare zr durante l'iterazione
* 
* LOGICA DELLA FUNZIONE:
* 1. Inizializza il contatore di profondità a 0
...
* - Questo crea una forma simmetrica e "mostruosa" rispetto al Mandelbrot originale
